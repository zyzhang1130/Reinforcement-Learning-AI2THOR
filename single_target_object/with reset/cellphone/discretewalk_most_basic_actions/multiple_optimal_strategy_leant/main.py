...
#            time.sleep(0.05) 
            ...
            if done and sought==1:
                ...
                # if num_steps>=args.learn_start:
                reward_history_seek.append([reward,num_steps])
                with open('reward_history_seek.pickle', 'wb') as f:
                ...
                sought=0
                if found==0:
                    reward_history_hide.append([4,num_steps])   
            ...
            if done and hidden==2:
                # if num_steps>=args.learn_start:
                reward_history_seek.append([30,num_steps])
                with open('reward_history_seek.pickle', 'wb') as f:
                    pickle.dump([reward_history_seek], f)
